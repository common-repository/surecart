...
const ScInvoiceDetails = class {
  ...
  render() {
    var _a;
    return (index.h(index.Host, { style: { ...(!((_a = mutations.state === null || mutations.state === void 0 ? void 0 : mutations.state.checkout) === null || _a === void 0 ? void 0 : _a.invoice) ? { display: 'none' } : {}) } }, index.h("div", { class: "invoice-details" }, index.h("slot", null))));
  }
};
