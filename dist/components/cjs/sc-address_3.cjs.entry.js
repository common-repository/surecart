...
const ScAddress = class {
  ...
  setRegions() {
    var _a;
    if (address.hasState((_a = this.address) === null || _a === void 0 ? void 0 : _a.country)) {
