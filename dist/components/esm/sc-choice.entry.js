...
const ScChoice = class {
  ...
  render() {
    return (h(Host, { tabindex: "0", onFocus: () => this.input.focus() }, h("div", { part: "base", class: {
        'choice': true,
